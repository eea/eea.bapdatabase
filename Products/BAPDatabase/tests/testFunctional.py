...
class BAPFunctionalTestCase(NaayaFunctionalTestCase):
    ...
    def test_A2_3_1(self):
        ...
        datatable = soup.find('table', attrs={'class':'datatable'})
        record = self.portal.bap.get_action_values('A2_3_1_Stations', country='Austria')
        self.assertTrue(hasattr(record, 'num'))

        datatable = soup.find('table', attrs={'class':'datatable'})
        record = self.portal.bap.get_action_values('A2_3_1_BioAsses', country='Austria')
    ...
    def test_A4_5_1(self):
        ...
        record = self.portal.bap.get_action_values('A4_5_1', country='France')
    ...
    def test_A5_2_2(self):
        ...
        record = self.portal.bap.get_action_values('A5_2_2', country='Austria')
    ...
    def test_C1_3_1(self):
        ...
        record = self.portal.bap.get_action_values('C1_3_1', country='Austria')
