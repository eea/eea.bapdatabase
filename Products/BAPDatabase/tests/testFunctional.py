...
class BAPFunctionalTestCase(NaayaFunctionalTestCase):
    ...
    def test_A2_1_3(self):
        ...
        record = self.portal.bap.get_action_values('A2_1_3_HNV', country='Austria')
    ...
    def test_A2_1_6(self):
        ...
        soup = BeautifulSoup(html)
        datatable = soup.find('table', attrs={'class':'datatable'})
        self.assertEqual(datatable.tr.th.text, 'Have training or advisory services been specifically designed to support the uptake of Axis 2 measures of benefit to biodiversity? Please enter Y or N here:')

        record = self.portal.bap.get_action_values('A2_1_6', country='Austria')
    ...
    def test_A2_1_9(self):
        ...
        soup = BeautifulSoup(html)
        datatable = soup.find('table', attrs={'class':'datatable'})
        self.assertEqual(datatable.tr.th.text, 'What was the amount of resources generated by additional rates of modulation that has been allocated to the new challenge \'biodiversity\'?')
    ...
    def test_A2_1_15(self):
        ...
        datatable = soup.find('table', attrs={'class':'datatable'})
        record = self.portal.bap.get_action_values('A2_1_15', country='Austria')
    ...
    def test_A3_4(self):
        ...
        record = self.portal.bap.get_action_values('A3_4', country='France')
    ...
    def test_A3_5_1(self):
        ...
        record = self.portal.bap.get_action_values('A3_5_1', country='France')
    ...
    def test_A3_5_2(self):
        ...
        record = self.portal.bap.get_action_values('A3_5_2', country='France')
    ...
    def test_A3_5_3(self):
        ...
        record = self.portal.bap.get_action_values('A3_5_3', country='France')
    ...
    def test_A3_6_1(self):
        ...
        record = self.portal.bap.get_action_values('A3_6_1', country='France')
    ...
    def test_A3_6_3(self):
        ...
        record = self.portal.bap.get_action_values('A3_6_3_Inshore', country='France')
        self.assertTrue(hasattr(record, 'Number'))
        record = self.portal.bap.get_action_values('A3_6_3_Offshore', country='France')
        self.assertTrue(hasattr(record, 'Number'))
    ...
    def test_A4(self):
        ...
        record = self.portal.bap.get_action_values('A4', country='Austria')
    ...
    def test_A4_3(self):
        ...
        record = self.portal.bap.get_action_values('A4_3', country='Austria')
    ...
    def test_A5_1(self):
        ...
        record = self.portal.bap.get_action_values('A5_1_AlienSpecies', country='Austria')
        self.assertTrue(hasattr(record, 'TotalAlien'))
        record = self.portal.bap.get_action_values('A5_1_AlienLegal', country='Austria')
    ...
    def test_A5_1_2(self):
        ...
        record = self.portal.bap.get_action_values('A5_1_2', country='Austria')
    ...
    def test_A6_1_1(self):
        ...
        record = self.portal.bap.get_action_values('A6_1_1', country='Austria')
    ...
    def test_A7_1(self):
        ...
        record = self.portal.bap.get_action_values('A7_1', country='Austria')
    ...
    def test_A7_1_3(self):
        ...
        record = self.portal.bap.get_action_values('A7_1_3', country='Austria')
